...
class MainWindow(QMainWindow):
    ...
    def process_video(self, url, model_path):
        ...
        frame_interval = int(frame_rate * 3)  # 3 saniye aralık
    ...
    def edit_annotations(self, image_folder, annotation_folder):
        ...
        for image_file in image_files:
            ...
            def draw_rectangle(event, x, y, flags, param):
                nonlocal ix, iy, drawing, manual_boxes, clone
                if event == cv2.EVENT_LBUTTONDOWN:
                    ...
                    for b in manual_boxes:
                        cv2.rectangle(temp_img, (b[1], b[2]), (b[3], b[4]), (0, 0, 255), 2)
                    ...
                    class_id = 0
                    manual_boxes.append([class_id, x1, y1, x2, y2])
            ...
            while True:
                ...
                # Model etiketleri
                for class_id, x1, y1, x2, y2 in model_boxes:
                    cv2.rectangle(img_display, (x1, y1), (x2, y2), (0, 255, 0), 2)
                    cv2.putText(img_display, f"Drone {class_id}", (x1, y1 - 5),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
                # Manuel etiketler
                for class_id, x1, y1, x2, y2 in manual_boxes:
                    cv2.rectangle(img_display, (x1, y1), (x2, y2), (0, 0, 255), 3)
                    cv2.putText(img_display, f"Manuel {class_id}", (x1, y1 - 5),
                ...
                if key == ord('s'):
                    ...
                    with open(annotation_path, 'w') as f:
                        for class_id, x1, y1, x2, y2 in all_boxes:
